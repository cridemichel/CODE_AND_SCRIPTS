...
#ifdef MAIN
COORD_TYPE Vc, E, Dtrans[NA], temp, S[NUMK], dummy, eta, Drot, gr[MAXBIN], invs, press;
COORD_TYPE Ptens[3], DQtens[3], DrSqTot[NA];
int MB[NUMV];
#else 
extern COORD_TYPE Vc, E, Dtrans[NA], temp, S[NUMK], dummy, eta, Drot, gr[MAXBIN], invs, press;
