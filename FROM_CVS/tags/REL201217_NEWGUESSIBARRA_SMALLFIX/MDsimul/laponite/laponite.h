...
*/
#define SAVE_LIST rx[0], ry[0], rz[0], rx[1], ry[1], rz[1], rx[2], ry[2], rz[2],\
                  vx[0], vy[0], vz[0], vx[1], vy[1], vz[1], vx[2], vy[2], vz[2],\
                  Fx[0], Fy[0], Fz[0], Fx[1], Fy[1], Fz[1], Fx[2], Fy[2], Fz[2],\
                  vxo1[0], vyo1[0], vzo1[0], vxo1[1], vyo1[1], vzo1[1], vxo1[2], vyo1[2], vzo1[2],\
                  vxo2[0], vyo2[0], vzo2[0], vxo2[1], vyo2[1], vzo2[1],vxo2[2], vyo2[2], vzo2[2]
#undef  EXT_SLST
#define EXT_SLST  &s, &s1, &s2, &Vol, &Vol1, &Vol2, &Vol1o1, &s1o1, &Vol1o2,\
                  &s1o2

/* Reduced list of variables to save on xva file (tape file) */ 
#define XVA_LIST rx[0], ry[0], rz[0], rx[1], ry[1], rz[1], rx[2], ry[2], rz[2],\
                 vx[0], vy[0], vz[0], vx[1], vy[1], vz[1], vx[2], vy[2], vz[2],\
                 Dphix, Dphiy, Dphiz

#define XVA_NUM 15 /* this is the number of vars in XVA_LIST <--- SET THIS!!!*/

#define XVA_ALST &rx[0], &ry[0], &rz[0], &rx[1], &ry[1], &rz[1], &rx[2], &ry[2], &rz[2],\
                 &vx[0], &vy[0], &vz[0], &vx[1], &vy[1], &vz[1], &vx[2], &vy[2], &vz[2],\
                 &Dphix, &Dphiy, &Dphiz
...
/* Follows a list of pointer to pointer to COORDTYPE.
   ...
   mdarray.c file).
*/
#define ALLOC_LIST  &rx[0], &ry[0], &rz[0], &rx[1], &ry[1], &rz[1], &rx[2], &ry[2], &rz[2],\
                    &vx[0], &vy[0], &vz[0], &vx[1], &vy[1], &vz[1], &vx[2], &vy[2], &vz[2],\
                    &Fx[0], &Fy[0], &Fz[0], &Fx[1], &Fy[1], &Fz[1], &Fx[2], &Fy[2], &Fz[2],\
                &vxt[0], &vyt[0], &vzt[0], &vxt[1], &vyt[1], &vzt[1], &vxt[2], &vyt[2], &vzt[2],\
                    &FxLJ[0], &FyLJ[0], &FzLJ[0],\
                    &FxLJ[1], &FyLJ[1], &FzLJ[1],\
                    &FxLJ[2], &FyLJ[2], &FzLJ[2],\
                    &vxo1[0], &vyo1[0], &vzo1[0],\
                    &vxo1[1], &vyo1[1], &vzo1[1],\
		    &vxo1[2], &vyo1[2], &vzo1[2],\
                    &vxo2[0], &vyo2[0], &vzo2[0],\
                    &vxo2[1], &vyo2[1], &vzo2[1],\
                    &vxo2[2], &vyo2[2], &vzo2[2],\
		    &vxg[0],  &vyg[0],  &vzg[0],\
                    &vxg[1],  &vyg[1],  &vzg[1],\
                    &vxg[2],  &vyg[2],  &vzg[2],\
		    &vxt2[0],  &vyt2[0],  &vzt2[0],\
                    &vxt2[1],  &vyt2[1],  &vzt2[1],\
                    &vxt2[2],  &vyt2[2],  &vzt2[2],\
		    &Rx, &Ry, &Rz
...
struct params
{
  ...
  COORD_TYPE m[3];                 /* atom mass */
  int nsites;
  COORD_TYPE rcut;              /* cutoff for the pair potential */ 
  double lambdaD;               /* Debye screening length */
#if 0
  double zplus;                 /* charge of positive counterions */
  double zminus;                /* charge of negative coions */
  double nplus;                 /* concentration of positive counterions */
  double nminus;                /* concentration of negative coions */
#endif
...
struct singlePar OsinglePar[] = { 
  ...
  */
  ...
  {"m1",       &Oparams.m[1],             CT},
  {"m2",       &Oparams.m[2],             CT},
  {"chargerim",  &Oparams.chargerim,    CT},
  {"chargeface", &Oparams.chargeface,    CT},
...
#endif
  {"rcut",              &OP(rcut),                        1,   1, "%.8G"},
  {"lambdaD",           &OP(lambdaD),                    1,   1,  "%.20G"},
#if 0
  {"zplus",             &OP(zplus),                       1,   1, "%.10G"},
  {"zminus",            &OP(zminus),                      1,   1, "%.10G"},
  {"nplus",             &OP(nplus),                       1,   1, "%.10G"},
  {"nminus",            &OP(nminus),                      1,   1, "%.10G"},
#endif
