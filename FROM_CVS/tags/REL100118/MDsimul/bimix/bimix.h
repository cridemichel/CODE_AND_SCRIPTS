...
struct params
{
  ...
  int equilibrat;               /* 1 = system equilibrated */
...
struct singlePar OsinglePar[] = { 
  ...
  */
  ...
  {"chkeqstps",  &OprogStatus.chkeqstps,      INT},
  ...
  {"taptausteps", &OprogStatus.taptausteps, INT},
  {"quenchend",   &OprogStatus.quenchend,   INT},
  {"partdamp",   &Oparams.partdamp,         CT}, 
#endif
