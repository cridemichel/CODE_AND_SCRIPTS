...
double gradcgfuncRyckSE(double *vec, double *grad, double *fx, double *gx, double *signA, double *signB)
{
  ...
  /* la norma dei gradienti � sempre stepSDA e stepSDB*/ 
...
#if 0
      /* WARNING: APPARENTEMENTE NON CONVIENE RISCALARE sol e sf se stepSDA � abbastanza piccolo,
       * ma verificare che questo � vero */
      else
	{
#if 0
