...
int main()
{
  using numty=double;
  rpoly<numty,10> rp;
  rpoly<numty,10,true> rphqr;
  pvector<numty, 11> c;
  //complex<numty> x1c, x2c, x3c, x4c, x5c, x6c;
  pvector<complex<numty>, 10> roots;
#if 1
#if 0
  cq[5] = 1.0;
  cq[4] = -2.0;
  ...
  //c << -1685011.48498632,162908947.86425, 464224691.56007,20202439788.8921,31022318528.7487, -352127.445371458,1;
   c << 1.0,1.0,1.0,1.0,-1685011.4849863185081630945205688,162908947.864249706268310546875,3464224691.560069561004638671875,20202439788.892055511474609375,31022318528.748729705810546875,-352127.44537145795766264200210571,1;
#endif
#if 0
  rp.set_coeff(c);
  rp.show();
