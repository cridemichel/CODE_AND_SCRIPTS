...
int mcsim=0, numbins=100;
double *saxhisto[3], *moihisto[3];
...
void main(int argc, char **argv)
{
  ...
  for (a=0; a < 3; a++)
    { 
      maxsax[a] = saxAnna[a]*3.0;
      minsax[a] = saxAnna[a]/3.0;
      maxmoi[a] = 1000000;
      minmoi[a] = 0;
      delsax[a] = (maxsax[a]-minsax[a])/numbins;
      delmoi[a] = (maxmoi[a]-minmoi[a])/numbins;
    }
