# $1 = volume fraction
# $2 = passi di produzione 
# $3 = elongazione
# $4 = temperatura
# $5 = sigma
# $6 = 2 model B / 1 fix bonding volume / 0 = do not fix bonding volume
# $7 = passi di equilibratura
FIXVB="1"
if [ "$1" = "" ]
then
echo "Syntax: sim1statepnt <temperature> <production steps> [elongation] [temperature] [sigma] <equilibration steps>"
exit 0
fi
if [ "$2" = "" ]
then
