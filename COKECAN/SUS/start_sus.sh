...
$SP $PF susnmin $NMIN susnmax $NMAX zetaMC $ACT npav $NPAV nexc $NEXC temperat $T bakSteps $BAKSTEPS stepnum $TOTSTPS VSteps $SAVESTPS  bakStepsAscii $BAKSTEPSASCII
$MR ./$EN -fa $PF > screen &
sleep $WT
cd ..
if [ $NFIN -lt $NINI ]
