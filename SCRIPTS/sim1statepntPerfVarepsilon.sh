...
$SETPARAMS rand_$PARFILE stepnum 10 targetPhi 0.0 storerate 0.0 intervalSum 0.2 scalevel 1 rcut $RCUT rNebrShell $RNNL endfile ${SIMRA}.cor parnum $PARNUM parnumA $PARNUMA A0 $A0 B0 $B0 C0 $C0 epsd $4 epsdMax $4 epsdFast $5 epsdFastR $5
ln -sf $ELLEXE $SIMRA
...
#exit
#CRESCITA
$SETPARAMS $PARFILE stepnum 1000000 targetPhi $1 storerate 0.0 intervalSum 0.05 rcut $RCUT rNebrShell $RNNL inifile ${SIMRA}.cor endfile ${SIMGR}.cor parnum $PARNUM parnumA $PARNUMA A0 $A0 B0 $B0 C0 $C0 epsd $4 epsdMax $4 epsdFast $5 epsdFastR $5
ln -sf $ELLEXE $SIMGR
