...
char **fname; 
double L, time, *ti, *rotMSD, *alpha2, *alpha2A, *alpha2B, *MSD, *rotMSDA, *MSDA, *rotMSDB, *MSDB, *cc, *rotMSDcls[2], *MSDcls[2], *cc_cls[2];
double **DR, **DR0;
double *r0[3], *w0[3], *rt[3], *wt[3], *rtold[3];
char parname[128], parval[1024000], line[1024000];
char dummy[512000];
